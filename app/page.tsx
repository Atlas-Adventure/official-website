...
const trekkingOffers = [
  {
    ...
    description:
      "Conquer the highest peaks of the High Atlas Mountains with breathtaking views and traditional Berber villages.",
    duration: "3 days",
    difficulty: "Advanced",
    price: "$899",
    highlights: ["Mount Toubkal (4,167m)", "Berber villages", "Stunning valleys"],
    image: "/placeholder.svg?height=300&width=400",
  },
  {
    id: 2,
    name: "One-Day Adventure to Imlil",
    description:
  ...
  },
  {
    ...
    description:
      "Explore the rugged beauty of the Anti-Atlas range with its unique rock formations and ancient kasbahs.",
    duration: "4 days",
    difficulty: "Easy",
    price: "$499",
    highlights: ["Rock formations", "Ancient kasbahs", "Argan forests"],
    image: "/placeholder.svg?height=300&width=400",
  },
  {
    id: 4,
    name: "Middle Atlas Explorer",
    description: "Discover cedar forests, mountain lakes, and traditional Amazigh culture in Morocco's Middle Atlas.",
    duration: "6 days",
    difficulty: "Moderate",
    price: "$749",
    highlights: ["Cedar forests", "Mountain lakes", "Amazigh culture"],
    image: "/placeholder.svg?height=300&width=400",
  },
  {
    id: 5,
